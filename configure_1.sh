...
EOF
  while true; do
    read -p "Do you want the defaults for all options? [yes]: " ac_tmp 
  ...
  if test "$defopt" = "no"; then
    while true; do
    read -p "Do you want to show the cycle counter? [yes]: " ac_tmp 
    if test "X$ac_tmp" = "X"; then
      ac_tmp="yes"
    fi
    if test "$ac_tmp" = "y" -o "$ac_tmp" = "ye" -o "$ac_tmp" = "yes"; then
...
EOF
    ...
    while true; do
    read -p "Do you want to enable VGA debugging? [no]: " ac_tmp 
    if test "X$ac_tmp" = "X"; then
      ac_tmp="no"
    fi
    if test "$ac_tmp" = "y" -o "$ac_tmp" = "ye" -o "$ac_tmp" = "yes"; then
...
EOF
    ...
    while true; do
    read -p "Do you want to enable Serial Port debugging? [no]: " ac_tmp 
    if test "X$ac_tmp" = "X"; then
      ac_tmp="no"
    fi
    if test "$ac_tmp" = "y" -o "$ac_tmp" = "ye" -o "$ac_tmp" = "yes"; then
...
EOF
    ...
    while true; do
    read -p "Do you want to enable one or more IDE debugging options? [no]: " ac_tmp 
    if test "X$ac_tmp" = "X"; then
      ac_tmp="no"
    fi
    if test "$ac_tmp" = "y" -o "$ac_tmp" = "ye" -o "$ac_tmp" = "yes"; then
    ...
    if test "$ide" = "yes"; then
      while true; do
    read -p "Do you want to enable all IDE debugging? [no]: " ac_tmp 
    if test "X$ac_tmp" = "X"; then
      ac_tmp="no"
    fi
    if test "$ac_tmp" = "y" -o "$ac_tmp" = "ye" -o "$ac_tmp" = "yes"; then
...
EOF
      ...
      if test "$dbg" = "no"; then
        while true; do
    read -p "Do you want to enable IDE Busmaster debugging? [no]: " ac_tmp 
    if test "X$ac_tmp" = "X"; then
      ac_tmp="no"
    fi
    if test "$ac_tmp" = "y" -o "$ac_tmp" = "ye" -o "$ac_tmp" = "yes"; then
...
EOF
        ...
        while true; do
    read -p "Do you want to enable IDE Command debugging? [no]: " ac_tmp 
    if test "X$ac_tmp" = "X"; then
      ac_tmp="no"
    fi
    if test "$ac_tmp" = "y" -o "$ac_tmp" = "ye" -o "$ac_tmp" = "yes"; then
...
EOF
        ...
        while true; do
    read -p "Do you want to enable IDE DMA debugging? [no]: " ac_tmp 
    if test "X$ac_tmp" = "X"; then
      ac_tmp="no"
    fi
    if test "$ac_tmp" = "y" -o "$ac_tmp" = "ye" -o "$ac_tmp" = "yes"; then
...
EOF
        ...
        while true; do
    read -p "Do you want to enable IDE Interrupt debugging? [no]: " ac_tmp 
    if test "X$ac_tmp" = "X"; then
      ac_tmp="no"
    fi
    if test "$ac_tmp" = "y" -o "$ac_tmp" = "ye" -o "$ac_tmp" = "yes"; then
...
EOF
        ...
        while true; do
    read -p "Do you want to enable IDE Command Register debugging? [no]: " ac_tmp 
    if test "X$ac_tmp" = "X"; then
      ac_tmp="no"
    fi
    if test "$ac_tmp" = "y" -o "$ac_tmp" = "ye" -o "$ac_tmp" = "yes"; then
...
EOF
        ...
        while true; do
    read -p "Do you want to enable IDE Control Register debugging? [no]: " ac_tmp 
    if test "X$ac_tmp" = "X"; then
      ac_tmp="no"
    fi
    if test "$ac_tmp" = "y" -o "$ac_tmp" = "ye" -o "$ac_tmp" = "yes"; then
...
EOF
        ...
        while true; do
    read -p "Do you want to enable IDE ATAPI Packet debugging? [no]: " ac_tmp 
    if test "X$ac_tmp" = "X"; then
      ac_tmp="no"
    fi
    if test "$ac_tmp" = "y" -o "$ac_tmp" = "ye" -o "$ac_tmp" = "yes"; then
...
EOF
        ...
        while true; do
    read -p "Do you want to enable IDE Thread debugging? [no]: " ac_tmp 
    if test "X$ac_tmp" = "X"; then
      ac_tmp="no"
    fi
    if test "$ac_tmp" = "y" -o "$ac_tmp" = "ye" -o "$ac_tmp" = "yes"; then
...
EOF
        ...
        while true; do
    read -p "Do you want to enable IDE Mutexes debugging? [no]: " ac_tmp 
    if test "X$ac_tmp" = "X"; then
      ac_tmp="no"
    fi
    if test "$ac_tmp" = "y" -o "$ac_tmp" = "ye" -o "$ac_tmp" = "yes"; then
...
EOF
    ...
    while true; do
    read -p "Do you want to enable unknown memory access debugging? [no]: " ac_tmp 
    if test "X$ac_tmp" = "X"; then
      ac_tmp="no"
    fi
    if test "$ac_tmp" = "y" -o "$ac_tmp" = "ye" -o "$ac_tmp" = "yes"; then
...
EOF
    ...
    while true; do
    read -p "Do you want to enable PCI debugging? [no]: " ac_tmp 
    if test "X$ac_tmp" = "X"; then
      ac_tmp="no"
    fi
    if test "$ac_tmp" = "y" -o "$ac_tmp" = "ye" -o "$ac_tmp" = "yes"; then
...
EOF
    ...
    while true; do
    read -p "Do you want to enable Translationbuffer debugging? [no]: " ac_tmp 
    if test "X$ac_tmp" = "X"; then
      ac_tmp="no"
    fi
    if test "$ac_tmp" = "y" -o "$ac_tmp" = "ye" -o "$ac_tmp" = "yes"; then
...
EOF
    ...
    while true; do
    read -p "Do you want to enable I/O Port Access debugging? [no]: " ac_tmp 
    if test "X$ac_tmp" = "X"; then
      ac_tmp="no"
    fi
    if test "$ac_tmp" = "y" -o "$ac_tmp" = "ye" -o "$ac_tmp" = "yes"; then
...
EOF
    ...
    while true; do
    read -p "Do you want to enable SCSI debugging? [no]: " ac_tmp 
    if test "X$ac_tmp" = "X"; then
      ac_tmp="no"
    fi
    if test "$ac_tmp" = "y" -o "$ac_tmp" = "ye" -o "$ac_tmp" = "yes"; then
...
EOF
    ...
    while true; do
    read -p "Do you want to enable Keyboard debugging? [no]: " ac_tmp 
    if test "X$ac_tmp" = "X"; then
      ac_tmp="no"
    fi
    if test "$ac_tmp" = "y" -o "$ac_tmp" = "ye" -o "$ac_tmp" = "yes"; then
...
EOF
    ...
    while true; do
    read -p "Do you want to enable Programmable Interrupt Controller (PIC) debugging? [no]: " ac_tmp 
    if test "X$ac_tmp" = "X"; then
      ac_tmp="no"
    fi
    if test "$ac_tmp" = "y" -o "$ac_tmp" = "ye" -o "$ac_tmp" = "yes"; then
...
EOF
    ...
    while true; do
    read -p "Do you want to enable Printer port debugging? [no]: " ac_tmp 
    if test "X$ac_tmp" = "X"; then
      ac_tmp="no"
    fi
    if test "$ac_tmp" = "y" -o "$ac_tmp" = "ye" -o "$ac_tmp" = "yes"; then
...
EOF
    ...
    while true; do
    read -p "Do you want to enable USB Controller debugging? [no]: " ac_tmp 
    if test "X$ac_tmp" = "X"; then
      ac_tmp="no"
    fi
    if test "$ac_tmp" = "y" -o "$ac_tmp" = "ye" -o "$ac_tmp" = "yes"; then
...
EOF
    ...
    while true; do
    read -p "Do you want to enable Symbios SCSI Controller debugging? [no]: " ac_tmp 
    if test "X$ac_tmp" = "X"; then
      ac_tmp="no"
    fi
    if test "$ac_tmp" = "y" -o "$ac_tmp" = "ye" -o "$ac_tmp" = "yes"; then
...
EOF
    ...
    while true; do
    read -p "Do you want to enable DMA Controller debugging? [no]: " ac_tmp 
    if test "X$ac_tmp" = "X"; then
      ac_tmp="no"
    fi
    if test "$ac_tmp" = "y" -o "$ac_tmp" = "ye" -o "$ac_tmp" = "yes"; then
...
EOF
    ...
    while true; do
    read -p "Do you want to enable backtrace on SIGSEGV debugging? [no]: " ac_tmp 
    if test "X$ac_tmp" = "X"; then
      ac_tmp="no"
    fi
    if test "$ac_tmp" = "y" -o "$ac_tmp" = "ye" -o "$ac_tmp" = "yes"; then
...
EOF
    ...
    while true; do
    read -p "Do you want to enable mutex debugging? [no]: " ac_tmp 
    if test "X$ac_tmp" = "X"; then
      ac_tmp="no"
    fi
    if test "$ac_tmp" = "y" -o "$ac_tmp" = "ye" -o "$ac_tmp" = "yes"; then
