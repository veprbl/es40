...
# Generated by GNU Autoconf 2.61 for es40 0.18+.
#
...
rm -f core conftest.err conftest.$ac_objext conftest_ipa8_conftest.oo \
  ...
  for i in /usr/ng/lib /usr/lib /usr/local/lib; do
    { echo "$as_me:$LINENO: checking for pcap library in $i" >&5
echo $ECHO_N "checking for pcap library in $i... $ECHO_C" >&6; }
...
echo "${ECHO_T}found" >&6; }
      ...
      { echo "$as_me:$LINENO: result: not here" >&5
echo "${ECHO_T}not here" >&6; }
    fi
  done


  for i in /usr/ng/include /usr/include /usr/local/include; do
    { echo "$as_me:$LINENO: checking for pcap header in $i" >&5
echo $ECHO_N "checking for pcap header in $i... $ECHO_C" >&6; }
...
echo "${ECHO_T}not here" >&6; }
  ...
  { echo "$as_me:$LINENO: checking whether pcap is available" >&5
echo $ECHO_N "checking whether pcap is available... $ECHO_C" >&6; }
...
echo "${ECHO_T}couldn't find any!" >&6; }
  ...
  { echo "$as_me:$LINENO: checking whether to use X11" >&5
echo $ECHO_N "checking whether to use X11... $ECHO_C" >&6; }
...
PCAP_CFLAGS!$PCAP_CFLAGS$ac_delim
